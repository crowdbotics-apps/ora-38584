"""
Django settings for ora_38584 project.
...
WSGI_APPLICATION = 'ora_38584.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ora_38584 API",
    "DESCRIPTION": "API documentation for ora_38584 App",
    "VERSION": "v1",
}
